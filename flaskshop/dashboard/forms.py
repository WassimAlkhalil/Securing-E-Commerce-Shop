...
class UniqueVoucherCode:
    """Validator to ensure voucher code is unique in the database"""

    def __init__(self, message=None):
        self.message = message or lazy_gettext("This voucher code already exists.")
    ...
    def __call__(self, form, field):
        ...
        if existing_voucher:
            exclude_id = getattr(form, "voucher_id", None)
            ...
            if exclude_id is None or existing_voucher.id != exclude_id:
...
class VoucherForm(FlaskForm):
    # Prevent duplicate voucher codes
    # @author: Nebil Müren - cas3322
    def __init__(self, *args, voucher_id=None, **kwargs):
    ...
    code = StringField(
        lazy_gettext("Code"),
        validators=[DataRequired(), UniqueVoucherCode()],
    )
