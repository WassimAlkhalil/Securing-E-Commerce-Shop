...
class Voucher(Model):
    ...
    def generate_code(cls):
        ...
        # Added recursive to give another 1/(26^16) chance
        # @author: Nebil Müren - cas3322
        return code if not exist else cls.generate_code()

    # Swarup usage Limit bug fix
    def check_available(self, cart=None):
        ...
        # Check usage limit
        if self.usage_limit is not None and self.used >= self.usage_limit:
                raise Exception("This voucher code has reached its usage limit.")
