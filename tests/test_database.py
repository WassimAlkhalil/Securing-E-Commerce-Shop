...
class TestCRUDMixin:
    ...
    def test_create(self):
        ...
        assert ExampleUserModel.get_by_id(user.id).username == "foo"# nosec

    def test_create_save(self):
        """Test CRUD create with save."""
        user = ExampleUserModel("foo", "foo@bar.com")
        user.save()
        assert ExampleUserModel.get_by_id(user.id) is not None# nosec
    ...
    def test_delete_with_commit(self):
        ...
        assert ExampleUserModel.get_by_id(user.id) is None# nosec
    ...
    def test_update(self, commit, expected, db):
        ...
        assert retrieved.username == expected# nosec
...
class TestPkModel:
    ...
    def test_get_by_id_wrong_type(self):
        ...
        assert ExampleUserModel.get_by_id("xyz") is None# nosec
